...
from run_blackjack import RunBlackjack
from const import *
                        ...
                        if SIDE_PANEL_WIDTH <= released_x < SIDE_PANEL_WIDTH + BOARD_WIDTH and 0 <= released_y < HEIGHT:
                            ...
                            if board.valid_move(dragger.piece, move):
                                ...
                                if captured_piece and captured_piece.color == 'black':
                                    ...
                                    rbj = RunBlackjack(game, screen)
                                    result = rbj.run_blackjack_ui(self.screen, self.game, dragger.piece.name, captured_piece.name, self.game.blackjack_ui)
...
#     pygame.display.set_caption("The Queen's Gamble")
    main = Main()
    main.mainloop()
# main = Main()
# main.mainloop()